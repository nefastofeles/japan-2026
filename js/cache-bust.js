...
const CURRENT_CACHE = "japan-2026-v40";
const RELOAD_FLAG = "japan-2026-cleared-v40";

function bootApp() {
  if (document.querySelector("script[data-app-boot]")) return;
  const script = document.createElement("script");
  script.type = "module";
  script.src = "js/app.js?v=40";
